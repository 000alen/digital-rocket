    ...
    <section className="relative flex flex-col items-center w-full max-w-3xl p-4">
      <div className="my-12">
        ...
        <div className="relative">
          ...
          <StaticImage
            className="!absolute w-[10.1%] h-[11.7%] left-[17.6%] top-[64.5%]"
            src="../images/avatars/santiago.jpg"
            alt=""
          />

          <StaticImage
            className="!absolute w-[10.1%] h-[11.7%] left-[32.9%] top-[57.5%]"
            src="../images/avatars/ivo.jpg"
            alt=""
          />

          <StaticImage
            className="!absolute w-[10.1%] h-[11.7%] left-[48.2%] top-[64.5%]"
            src="../images/avatars/gonzalo.jpg"
            alt=""
          />

          <StaticImage
            className="!absolute w-[10.1%] h-[11.7%] left-[63%] top-[56.8%]"
            src="../images/avatars/claudio.jpg"
            alt=""
          />

          <StaticImage
            className="!absolute w-[10.1%] h-[11.7%] left-[78.9%] top-[66.1%]"
