...
export const IdeaIcon: React.FC<Props> = ({ className = "w-6 h-6" }) => {
  return (
    <svg
      className={`${className} inline select-none fill-white`}
      version="1.1"
      id="Layer_1"
    ...
    >
      <g transform="translate(0 -540.36)">
        <g>
          <g>
            <path
              d="M328.376,631.36c2.6,0,5.1-1,7-2.9l41.9-41.2c3.9-3.8,4-10.2,0.1-14.1c-3.8-3.9-10.2-4-14.1-0.1l-41.9,41.2
c-3.9,3.8-4,10.2-0.1,14.1C323.176,630.36,325.776,631.36,328.376,631.36z"
            />
            <path
              d="M153.076,628.56c1.9,1.9,4.4,2.8,6.9,2.8c2.6,0,5.2-1,7.2-3c3.9-3.9,3.8-10.3-0.2-14.1l-42.7-41.2
c-3.9-3.9-10.2-3.7-14.1,0.2c-3.9,3.9-3.8,10.3,0.2,14.1L153.076,628.56z"
            />
            <path
              d="M243.776,620.66c5.5,0,10-4.5,10-10v-60.3c0-5.5-4.5-10-10-10s-10,4.5-10,10v60.3
C233.776,616.16,238.276,620.66,243.776,620.66z"
            />
            <path
              d="M375.976,739.26L375.976,739.26c-8-28.4-24.9-52.7-49-70.4c-24-17.6-52.8-26.9-83.2-26.9c-30.1,0-58.7,9.3-82.6,27
